...
echo "[JOB] Hybrid Parser: Cache + Log Grouper"
python datasets/loghub-2.0/benchmark/evaluation/Hybrid_eval.py --full_data --run_name Run_CacheGrouper --device cpu --use_grouper
