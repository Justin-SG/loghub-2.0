...
# Note: Drain is typically CPU-bound. We don't request GPU explicitly but run on 2080 partition.
...
echo "[JOB] Reference: Drain"
python datasets/loghub-2.0/benchmark/evaluation/Drain_eval.py --full_data
