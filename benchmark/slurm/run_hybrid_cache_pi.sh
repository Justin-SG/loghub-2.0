...
echo "[JOB] Hybrid Parser: Cache + ParamIdentifier"
python datasets/loghub-2.0/benchmark/evaluation/Hybrid_eval.py --full_data --run_name Run_CachePI_No_regex --device cpu --no_grouper --use_param_identifier
